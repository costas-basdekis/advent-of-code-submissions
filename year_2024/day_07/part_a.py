...
class Calibration:
    ...
    @classmethod
    def from_text(cls, text: str) -> "Calibration":
        """
        ...
        9
        """
        return cls(equations=list(map(Equation.from_text, text.strip().splitlines())))

    def get_viable_calibration_result(self) -> int:
        """
        ...
        3749
        """
        return self.viable_only().get_calibration_result()

    def viable_only(self) -> "Calibration":
        """
        >>> len(Calibration.from_text('''
        ...     190: 10 19
        ...     3267: 81 40 27
